                ...
                {EXPERIENCES.map((experience, index) => (
                    <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                        <div className="w-full lg:w-1/4">
                            <h3 className="mb-2 text-sm text-neutral-500">{experience.year}</h3>
                        </div>
                        <div className="w-full max-w-xl lg:w-3/4">
                            <h6 className="mb-2 font-semibold">{experience.role} - <span className="text-smn text-purple-300"> {experience.company}</span> </h6>
